...
function Home() {
    ...
    const handlesubmit = (newrow) => {
        const updatedRow = {
            ...rows[rowedit], // agar rowedit mavjud bo'lsa, o'sha qatorni yangilash
            ...newrow, // yangi forma ma'lumotlarini qo'shish
        };
    
        // Agar rowedit mavjud bo'lsa, o'sha qatorni yangilaymiz
        if (rowedit !== null) {
            setrows(rows.map((currow, idx) => (idx === rowedit ? updatedRow : currow)));
        } else {
            // Agar rowedit mavjud bo'lmasa, yangi qator qo'shamiz
